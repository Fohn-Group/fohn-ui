...
$vp->onPageRequest(static function ($page) use ($vp, $vp2) {
...
// button that trigger virtual page.
$btn = Button::addTo(Ui::layout(), ['label' => 'Open Virtual Page', 'color' => 'secondary', 'type' => 'text']);
...
// button that trigger virtual page.
$btn = Button::addTo(Ui::layout(), ['label' => 'Display in a new layout', 'color' => 'secondary', 'type' => 'text']);
$btn->jsLinkTo($vp2->getUrl());
