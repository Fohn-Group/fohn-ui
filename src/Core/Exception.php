...
/**
 * All exceptions generated by Ui will use this class.
 */
class Exception extends \Exception
{
    ...
    {
        return (string) new ExceptionRenderer\Console($this);
    }
     ...
     *
     *   $l = new \Fohn\Ui\App();
     *   $l->initLayout(\Fohn\Ui\Layout\Centered::class);
    ...
    {
        return (string) new ExceptionRenderer\Html($this);
    }
    ...
    {
        return (string) new ExceptionRenderer\Json($this);
    }
