...
class View extends AbstractView
{
     ...
     */
    public function appendHtmlStyle(string $property, string|null $style = null): self
    {
    ...
    public function appendHtmlAttribute(string $attribute, string|null $value = null): self
    {
        if ($value || $value === null) {
     ...
     */
    public function renderToJsonArr(string|null $region = null): array
    {
     ...
     */
    public function stickyGet(string $name, string|null $newValue = null): ?string
    {
